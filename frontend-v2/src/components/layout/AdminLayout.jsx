              ...
              <Dialog.Panel className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
                ...
                <div className="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                  <div className="flex-shrink-0 flex items-center px-4">
                    <h1 className="text-xl font-bold text-primary-600">FF Admin</h1>
                  </div>
                ...
                <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      <div className="h-8 w-8 rounded-full bg-danger-500 flex items-center justify-center">
          ...
          <div className="flex flex-col h-0 flex-1 border-r border-gray-200 bg-white">
            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
              <div className="flex items-center flex-shrink-0 px-4">
                <h1 className="text-xl font-bold text-primary-600">FF Admin</h1>
                <span className="ml-2 text-xs bg-danger-100 text-danger-700 px-2 py-1 rounded-full">
                  ADMIN
                </span>
              </div>
